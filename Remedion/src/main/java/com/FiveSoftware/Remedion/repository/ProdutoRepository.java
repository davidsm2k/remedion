...
public interface ProdutoRepository extends JpaRepository<Produto, Long> {
	...
	public List<Produto> findAllByNomeContainingIgnoreCaseAndMunicipioCidadeContainingIgnoreCaseAndZonaContainingIgnoreCase(
			String nome, String municipioCidade, String zona);
